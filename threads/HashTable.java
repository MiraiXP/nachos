...
public class HashTable {	
    ...
    public void put(String key, int v) throws Exception{
          ...
          System.out.println("This is key " + key + " " + debug_flag +" "+ SIZE);
          System.out.println("hash: " +hash +" " + hTable[hash].getKey()+ " " + hTable[hash].getValue());
          if(hTable[hash].getKey() != null) {
        	  System.out.println("This is getkey != null");
        	  if (hTable[hash].getKey() == key) {
        		  System.out.println("This is getkey == key " + key + " "+ hTable[hash].getKey());
                  throw new HashTableException("Duplicated Key");
        	  }
        	  ...
        	  System.out.println("KVPAIR: " + key +" "+ v + " " + hTable[hash].getKey());
    ...
    public int get(String key) throws Exception{
    	...
    	if(hTable[hash].getKey() == null){
    		System.out.println("This is going down the path of getkey == null");
    		throw new HashTableException("Does not exist");
    	} else if(hTable[hash].getKey() == key){
    		
    		System.out.println("key != nul This is key == key");
    		return hTable[hash].getValue();
    	} else {
    		KVPair temp = hTable[hash];
    		System.out.println("This is temp = htable[hash]");
    		while(temp.getNext() != null) {
    ...
    public static void selfTest(){
    	...
    	try {
    		...
    		System.out.println("This is put start");
    		table.put("abc", 30);
    		table.put("bcd", 32);
    		table.put("cde", 34);
System.out.println();
    		System.out.println("This is put end, get started");
    		...
    		System.out.println("This is get end, outstart");
    		table.out("bcd");
    		...
    		table2.put("bca", 32);
    		table2.put("cba", 34);
    		System.out.println("This is put end");
    		//three clashed keys, delete one of them
    		System.out.println("This is table.out");
    		table2.out("bca");
    		System.out.println("end of bca out");
    		Lib.assertTrue(table2.get("abc") == 30);
    		System.out.println("This is get start");
    		Lib.assertTrue(table2.get("cba") == 34);
    		System.out.println("This is get end, count start =2");
